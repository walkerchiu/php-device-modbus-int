...
class AddressRepositoryTest extends \Orchestra\Testbench\TestCase
{
    ...
    public function testEnableAndDisable()
    {
        ...
        factory(Main::class)->create();
        factory(Setting::class)->create();
        factory(Address::class)->create(['is_enabled' => 1]);
    ...
    public function testFormTrait()
    {
        ...
        // Serial, Identifier
            // Give
            factory(Address::class)->create(['serial' => '123', 'identifier' => 'A123']);
            factory(Address::class)->create(['serial' => '124', 'identifier' => 'A124']);
            factory(Address::class)->create(['serial' => '125', 'identifier' => 'A125', 'is_enabled' => 0]);
    ...
    public function testAutoComplete()
    {
        ...
        factory(Main::class)->create();
        factory(Setting::class)->create();
        factory(Address::class)->create(['serial' => 'A123', 'is_enabled' => 1]);
        factory(Address::class)->create(['serial' => 'A124', 'is_enabled' => 1]);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Address::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Address::class, 'code' => 'en_us', 'key' => 'description', 'value' => 'Good Morning!']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Address::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello World']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Address::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Address::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '早安']);
        $this->repository->createLangWithoutCheck(['morph_id' => 2, 'morph_type' => Address::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Bye']);
