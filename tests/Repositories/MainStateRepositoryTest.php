...
class MainStateRepositoryTest extends \Orchestra\Testbench\TestCase
{
    ...
    public function testcreateLangWithoutCheck()
    {
        ...
        factory(Channel::class)->create();
        factory(Main::class)->create();
        factory(MainState::class)->create();
    ...
    public function testEnableAndDisable()
    {
        ...
        factory(Channel::class)->create();
        factory(Main::class)->create();
        factory(MainState::class)->create(['is_enabled' => 1]);
        factory(MainState::class, 3)->create();
    ...
    public function testQueryList()
    {
        ...
        factory(Channel::class)->create();
        factory(Main::class)->create();
        factory(MainState::class, 4)->create();
    ...
    public function testFormTrait()
    {
        ...
        // Name
            ...
            $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => MainState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
            $this->repository->createLangWithoutCheck(['morph_id' => 2, 'morph_type' => MainState::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
            // When
        ...
        // Serial, Identifier
            // Give
            factory(MainState::class)->create(['serial' => '123', 'identifier' => 'A123']);
            factory(MainState::class)->create(['serial' => '124', 'identifier' => 'A124']);
            factory(MainState::class)->create(['serial' => '125', 'identifier' => 'A125', 'is_enabled' => 0]);
    ...
    public function testAutoComplete()
    {
        ...
        factory(Channel::class)->create();
        factory(Main::class)->create();
        factory(MainState::class)->create(['serial' => 'A123', 'is_enabled' => 1]);
        factory(MainState::class)->create(['serial' => 'A124', 'is_enabled' => 1]);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => MainState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => MainState::class, 'code' => 'en_us', 'key' => 'description', 'value' => 'Good Morning!']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => MainState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello World']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => MainState::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => MainState::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '早安']);
        $this->repository->createLangWithoutCheck(['morph_id' => 2, 'morph_type' => MainState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Bye']);
