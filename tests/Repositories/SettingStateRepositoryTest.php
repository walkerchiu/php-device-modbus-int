...
class SettingStateRepositoryTest extends \Orchestra\Testbench\TestCase
{
    ...
    public function testcreateLangWithoutCheck()
    {
        ...
        factory(Main::class)->create();
        factory(Setting::class)->create();
        factory(SettingState::class)->create();
    ...
    public function testEnableAndDisable()
    {
        ...
        factory(Main::class)->create();
        factory(Setting::class)->create();
        factory(SettingState::class)->create(['is_enabled' => 1]);
        factory(SettingState::class, 3)->create();
    ...
    public function testQueryList()
    {
        ...
        factory(Main::class)->create();
        factory(Setting::class)->create();
        factory(SettingState::class, 4)->create();
    ...
    public function testFormTrait()
    {
        ...
        // Name
            ...
            $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => SettingState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
            $this->repository->createLangWithoutCheck(['morph_id' => 2, 'morph_type' => SettingState::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
            // When
        ...
        // Serial, Identifier
            // Give
            factory(SettingState::class)->create(['serial' => '123', 'identifier' => 'A123']);
            factory(SettingState::class)->create(['serial' => '124', 'identifier' => 'A124']);
            factory(SettingState::class)->create(['serial' => '125', 'identifier' => 'A125', 'is_enabled' => 0]);
    ...
    public function testAutoComplete()
    {
        ...
        factory(Main::class)->create();
        factory(Setting::class)->create();
        factory(SettingState::class)->create(['serial' => 'A123', 'is_enabled' => 1]);
        factory(SettingState::class)->create(['serial' => 'A124', 'is_enabled' => 1]);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => SettingState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => SettingState::class, 'code' => 'en_us', 'key' => 'description', 'value' => 'Good Morning!']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => SettingState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello World']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => SettingState::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => SettingState::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '早安']);
        $this->repository->createLangWithoutCheck(['morph_id' => 2, 'morph_type' => SettingState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Bye']);
