...
class SettingRepositoryTest extends \Orchestra\Testbench\TestCase
{
    ...
    public function testQueryList()
    {
        ...
        factory(Channel::class)->create();
        factory(Main::class)->create();
        factory(Setting::class, 4)->create();
    ...
    public function testFormTrait()
    {
        ...
        // Serial, Identifier
            // Give
            factory(Setting::class)->create(['serial' => '123', 'identifier' => 'A123']);
            factory(Setting::class)->create(['serial' => '124', 'identifier' => 'A124']);
            factory(Setting::class)->create(['serial' => '125', 'identifier' => 'A125', 'is_enabled' => 0]);
