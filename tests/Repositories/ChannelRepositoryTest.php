...
class ChannelRepositoryTest extends \Orchestra\Testbench\TestCase
{
    ...
    public function testEnableAndDisable()
    {
        ...
        // Give
        factory(Channel::class)->create(['is_enabled' => 1]);
    ...
    public function testQueryList()
    {
        ...
        // Give
        factory(Channel::class, 4)->create();
    ...
    public function testFormTrait()
    {
        ...
        // Name
            ...
            $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Channel::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
            $this->repository->createLangWithoutCheck(['morph_id' => 2, 'morph_type' => Channel::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
            // When
        ...
        // Serial, Identifier
            // Give
            factory(Channel::class)->create(['serial' => '123', 'identifier' => 'A123']);
            factory(Channel::class)->create(['serial' => '124', 'identifier' => 'A124']);
            factory(Channel::class)->create(['serial' => '125', 'identifier' => 'A125', 'is_enabled' => 0]);
    ...
    public function testAutoComplete()
    {
        ...
        // Give
        factory(Channel::class)->create(['serial' => 'A123', 'is_enabled' => 1]);
        factory(Channel::class)->create(['serial' => 'A124', 'is_enabled' => 1]);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Channel::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Channel::class, 'code' => 'en_us', 'key' => 'description', 'value' => 'Good Morning!']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Channel::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello World']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Channel::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Channel::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '早安']);
        $this->repository->createLangWithoutCheck(['morph_id' => 2, 'morph_type' => Channel::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Bye']);
