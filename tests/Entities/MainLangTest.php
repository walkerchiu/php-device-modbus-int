...
class MainLangTest extends \Orchestra\Testbench\TestCase
{
    ...
    public function testMainLang()
    {
        ...
        factory(MainLang::class)->create(['morph_id' => 1, 'morph_type' => Main::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        factory(MainLang::class)->create(['morph_id' => 1, 'morph_type' => Main::class, 'code' => 'en_us', 'key' => 'description']);
        factory(MainLang::class)->create(['morph_id' => 1, 'morph_type' => Main::class, 'code' => 'zh_tw', 'key' => 'description']);
        factory(MainLang::class)->create(['morph_id' => 1, 'morph_type' => Main::class, 'code' => 'en_us', 'key' => 'name']);
        factory(MainLang::class)->create(['morph_id' => 2, 'morph_type' => Main::class, 'code' => 'en_us', 'key' => 'name']);
        factory(MainLang::class)->create(['morph_id' => 2, 'morph_type' => Main::class, 'code' => 'zh_tw', 'key' => 'description']);
    ...
    public function testMain()
    {
        ...
        // Get lang of record
            // When
            $record_1 = Main::find(1);
            $lang_1   = MainLang::find(1);
            $lang_4   = MainLang::find(4);
            // Then
